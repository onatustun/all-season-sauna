    ...
    <nav className="w-full bg-background mx-auto flex justify-between items-center p-6 md:px-8 lg:px-24 xl:px-36">
      <Link href="/" className="flex items-center gap-2">
        <div className="aspect-square h-9 rounded-full">
          <img src="/logo-light.svg" alt="logo | © 2025 Onat Ustun" className="block dark:hidden h-full w-full object-cover" />
          <img src="/logo-dark.svg" alt="logo | © 2025 Onat Ustun" className="hidden dark:block h-full w-full object-cover" />
        </div>
