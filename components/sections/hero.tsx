      ...
      <div className="text-gray-600 space-y-8 gap-x-8 lg:gap-x-24 xl-gap-x-36 items-center justify-between md:flex">
        <div className="text-left md:flex-none space-y-6 md:space-y-8">
          <h2 className="text-5xl md:text-6xl lg:text-7xl xl:text-8xl text-foreground font-medium tracking-tight">
            ...
            <FlipWords
              words={words}
              className="max-w-[0px] text-nowrap overflow-visible"
            />
            <br />
            in every session.
          </h2>
          ...
          <Link
            href="/external"
            className="bg-primary text-background max-sm:text-lg text-sm lg:text-lg max-sm:w-full max-sm:rounded-xl max-sm:gap-4 rounded-full px-5 py-3 h-fit w-fit flex items-center justify-center gap-2 whitespace-nowrap text-sm lg:text-base font-medium"
          >
            Book Now
            <LuArrowRight />
          </Link>
